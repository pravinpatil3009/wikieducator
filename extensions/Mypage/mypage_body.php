...
class Mypage {
	...
	static function mypageRender( $input, array $args, Parser $parser, PPFrame $frame ) {
		...
		$ret .= '</div>';
		$ret .= '<div id="columns1">';
		$ret .= "<a class='twitter-timeline' href='https://twitter.com/$ttid' data-widget-id='444787449160429569' data-screen-name='$ttid' data-show-replies='false' data-tweet-limit='30'>Tweets by @$ttid</a>";
